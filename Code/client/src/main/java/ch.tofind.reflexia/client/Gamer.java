package ch.tofind.reflexia.client;
...
import ch.tofind.reflexia.protocol.GamerProtocol;
...
public class Gamer implements GamerProtocol {
    ...
    /**
     * This function allows to load the ch.tofind.reflexia.game configuration
     *
